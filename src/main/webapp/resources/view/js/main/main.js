...
function menu_click() {
	var sideMenuPanel = Ext.getCmp('sideMenuPanel');

    if(sideMenuPanel!=null && sideMenuPanel!=undefined) {
        sideMenuPanel.toggleCollapse();
        
        var collapsed = sideMenuPanel.collapsed;
        var hidden = sideMenuPanel.hidden;
        // if(!collapsed) {
        //     sideMenuPanel.setHidden(false);
        // } else {
        //     sideMenuPanel.setHidden(true);
        // }
    }
