Ext.define('Msys.views.approval.SendApprovalView', {
    ...
    initComponent: function () {
      ...
      //PDF 파일 출력기능
		...
		//스토어 생성
        this.createStore('Msys.model.SendApprovalModel', gu.pageSize);
    ...
    createCenter: function() {
		...
		var menu_code = 'SEND_APPROVAL_SUB';
        var options = [];      
        //스토어 생성
        this.subGridStore = this.createSubStore('Msys.model.SendApprovalSubModel', gu.pageSize, menu_code);
        //그리드 생성
