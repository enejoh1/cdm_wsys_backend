Ext.define('Msys.views.sales.RegistProjectMgmtView', {
    extend:'Msys.base.BaseView',
    // xtype:'PJ_REGIST',
    initComponent: function() {
        console.log('MSYS Views Sales RegistProjectMgmtView', this.DEFAULT_BUTTON_NAME);
        ...
        this.createStore('Msys.model.RegistProjectMgmtModel', gu.pageSize);
            ...
            columns: [
                {
                    ...
                    renderer: function(value, meta, record) {
                        var sales_price = record.get('static_sales_price');
    ...
    addItemHandler: function() {
        ...
        var saveForm = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                {text: "수량", width:'15%', dataIndex: 'bm_quan', sortable: true, editor:{},
                    css: 'edit-cell',
                    renderer: function(value, meta) {
                        meta.css = 'custom-column';
