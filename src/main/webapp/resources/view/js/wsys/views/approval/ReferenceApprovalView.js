Ext.define('Msys.views.approval.ReferenceApprovalView', {
    ...
    initComponent: function () {
      ...
      //PDF 파일 출력기능
		...
		//스토어 생성
        this.createStore('Msys.model.ReferenceApprovalModel', gu.pageSize);
    ...
    createCenter: function() {
		...
		var menu_code = 'REF_APPROVAL_SUB';
        var options = [];      
        //스토어 생성
        this.subGridStore = this.createSubStore('Msys.model.ReferenceApprovalSubModel', gu.pageSize, menu_code);
        //그리드 생성
