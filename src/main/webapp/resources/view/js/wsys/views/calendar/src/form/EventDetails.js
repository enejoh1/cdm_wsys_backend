...
Ext.define('Ext.calendar.form.EventDetails', {
    ...
    requires: [
        ...
        'Ext.calendar.form.field.SimpleCombo'
    ],
    ...
    title: '일정 양식', //'Event Form',
    titleTextAdd: '일정 추가', //'Add Event',
    titleTextEdit: '일정 수정', //'Edit Event',
    bodyStyle: 'background:transparent;padding:20px 20px 10px;',
    border: false,
    buttonAlign: 'center',
    autoHeight: true,
    ...
    initComponent: function() {
        ...
        if (this.calendarStore) {
            this.calendarField = new Ext.calendar.form.field.SimpleCombo({
    ...
    loadRecord: function(rec){
        ...
        var IsAllDay = rec.get('IsAllDay');
        if(IsAllDay) {
        	console_logs('IsAllDay', 'true');
        } else {
        	console_logs('IsAllDay', 'false');
        }
