...
Ext.define('Ext.calendar.data.EventStore', {
    ...
    listeners: {
        ...
        load: function(store, records, successful,operation, options) {
    		...
    		console_logs('EventStore records', records);
    	}
...
//        this.model = Ext.create('Ext.calendar.data.EventModel', {
//        	fields: this.fields
//        });
    ...
    interceptCreateRecords: function(records, operation, success) {
    	//console_logs('EventStore interceptCreateRecords', records);
    ...
    initRecs: function(){
    	//console_logs('EventStore initRecs', this);
//    	this.removeAll(true);
        this.each(function(rec){
        	//console_logs('EventStore initRecs rec', rec);
            rec.store = this;
            rec.phantom = false;
        }, this);
    },
    ...
    onProxyLoad: function(operation) {
    	//console_logs('EventStore initRecs', operation);
        var me = this,
            records;
        ...
        if (me.data && me.data.length > 0) {
            ...
            //console_logs('EventStore initRecs records', records);
            if (resultSet) {
