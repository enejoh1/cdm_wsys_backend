Ext.define('Msys.views.design.EtcMgmtView', {
    extend:'Msys.base.BaseView',
    // xtype:'PJ_REGIST',
    initComponent: function() {
	
        console.log('MSYS Views design EtcMgmtView', this.columns);
        ...
        this.addEtcAction = Ext.create('Ext.Action', {
            xtype : 'button',
            iconCls: 'af-plus-circle',
            text: '추가',
            tooltip: '제품을 등록합니다.',
            handler: function() {
                gm.me().manageEtcHandler('ADD');
            }
        });

        this.editEtcAction = Ext.create('Ext.Action', {
            xtype : 'button',
            iconCls: 'af-edit',
            text: '수정',
            disabled: true,
            tooltip: '제품을 수정합니다.',
            handler: function() {
                gm.me().manageEtcHandler('EDIT');
            }
        });

        this.copyEtcAction = Ext.create('Ext.Action', {
            xtype : 'button',
            iconCls: 'af-copy',
            text: '복사등록',
            disabled: true,
            tooltip: '제품을 복사등록합니다.',
            handler: function() {
                gm.me().manageEtcHandler('COPY');
            }
        });

        this.removeEtcAction = Ext.create('Ext.Action', {
            xtype : 'button',
            iconCls: 'af-remove',
            text: '삭제',
            disabled: true,
            ...
            handler: function() {
                Ext.MessageBox.show({
                    ...
                    fn: gm.me().removeEtcHandler,
                    icon: Ext.MessageBox.QUESTION
                });
            }
        });

        buttonToolbar.insert(1, this.addEtcAction);
        buttonToolbar.insert(2, this.editEtcAction);
        buttonToolbar.insert(3, this.copyEtcAction);
        buttonToolbar.insert(4, this.removeEtcAction);

		//스토어 생성
        this.createStore('Msys.model.EtcMgmtModel', gu.pageSize);
        ...
        this.grid.getSelectionModel().on({
            selectionchange: function(s, selections) {
                if(selections.length) {
                    ...
                    gm.me().editEtcAction.enable();
                    gm.me().copyEtcAction.enable();
                    gm.me().removeEtcAction.enable();
                } else {
                    gm.me().editEtcAction.disable();
                    gm.me().copyEtcAction.disable();
                    gm.me().removeEtcAction.disable();
                }
            }
        });
    ...
    manageEtcHandler: function(type) {
        ...
        var form = Ext.create('Ext.form.Panel', {
            ...
            items: [
                ...
                }),
                {
                    ...
                    text:'중복확인',
                    handler: function() {
                        var item_code = Ext.getCmp(gu.id('manage_etc_item_code')).getValue();
                    ...
                    items: [
                        {
                            ...
                            items: [
                                {
                                    xtype:'combo',
                                    id:gu.id('manage_etc_account_type'),
                                    name:'account_type',
                                    mode: 'local',
                                    padding: '0 0 5px 0',
                                    ...
                                    value:type=='EDIT'||type=='COPY' ? select.get('account_type') : 'E'
                                },{
                                    xtype:'combo',
                                    id:gu.id('manage_etc_class_1'),
                                    name:'class_1',
                                    mode: 'local',
                                    ...
                                    xtype:'textfield',
                                    id:gu.id('manage_etc_specification'),
                                    name:'specification',
                                    padding: '0 0 5px 30px',
                                    width:'45%',
                                    allowBlank:false,
                                    ...
                                    xtype:'numberfield',
                                    id:gu.id('manage_etc_std_sell_price'),
                                    name:'std_sell_price',
                                    padding: '0 0 5px 0',
                                    width:'45%',
                                    fieldLabel:'표준판매단가',
                                    ...
                                    xtype:'numberfield',
                                    id:gu.id('manage_etc_std_pur_price'),
                                    name:'std_pur_price',
                                    padding: '0 0 5px 30px',
                                    width:'45%',
                                    fieldLabel:'표준구매단가',
                                    ...
                                    xtype:'textfield',
                                    id:gu.id('manage_etc_description'),
                                    name:'description',
                                    padding: '0 0 5px 30px',
                                    width:'45%',
                                    fieldLabel:'설명',
        ...
        var win = Ext.create('Ext.Window', {
            ...
            buttons: [{
                ...
                handler: function(btn) {
                    var form = Ext.getCmp(gu.id('manage_etc_form')).getForm();
                    if(form.isValid()) {
    ...
    accountTypeStore:Ext.create('Msys.store.CommonCodeStore', {code_group:'ETC_ACCOUNT'}),
