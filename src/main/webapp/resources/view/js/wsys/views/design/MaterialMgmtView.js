Ext.define('Msys.views.design.MaterialMgmtView', {
    extend:'Msys.base.BaseView',
    // xtype:'PJ_REGIST',
    initComponent: function() {
	
        console.log('MSYS Views design MaterialMgmtView', this.columns);
        ...
        this.addMtrlAction = Ext.create('Ext.Action', {
            ...
            tooltip: '자재을 등록합니다.',
            handler: function() {
                gm.me().manageMtrlHandler('ADD');
            }
        });

        this.editMtrlAction = Ext.create('Ext.Action', {
            xtype : 'button',
            iconCls: 'af-edit',
            text: '수정',
            disabled: true,
            tooltip: '자재을 수정합니다.',
            handler: function() {
                gm.me().manageMtrlHandler('EDIT');
            }
        });

        this.copyMtrlAction = Ext.create('Ext.Action', {
            xtype : 'button',
            iconCls: 'af-copy',
            text: '복사등록',
            disabled: true,
        ...
        this.removeMtrlAction = Ext.create('Ext.Action', {
            ...
            handler: function() {
                Ext.MessageBox.show({
                    ...
                    fn: gm.me().removeMtrlHandler,
                    icon: Ext.MessageBox.QUESTION
                });
            }
        });

        buttonToolbar.insert(1, this.addMtrlAction);
        buttonToolbar.insert(2, this.editMtrlAction);
        buttonToolbar.insert(3, this.copyMtrlAction);
        buttonToolbar.insert(4, this.removeMtrlAction);

		//스토어 생성
        this.createStore('Msys.model.MaterialMgmtModel', gu.pageSize);
        ...
        this.grid.getSelectionModel().on({
            selectionchange: function(s, selections) {
                if(selections.length) {
                    ...
                    gm.me().editMtrlAction.enable();
                    gm.me().copyMtrlAction.enable();
                    gm.me().removeMtrlAction.enable();
                } else {
                    gm.me().editMtrlAction.disable();
                    gm.me().copyMtrlAction.disable();
                    gm.me().removeMtrlAction.disable();
                }
            }
        });
    ...
    manageMtrlHandler: function(type) {
        ...
        var form = Ext.create('Ext.form.Panel', {
            ...
            items: [
                ...
                {
                    xtype:'textfield',
                    id:gu.id('manage_mtrl_item_code'),
                    name:'item_code',
                    padding: '0 0 5px 0',
                    width:'85%',
                    allowBlank:false,
                    ...
                    text:'중복확인',
                    handler: function() {
                        var item_code = Ext.getCmp(gu.id('manage_mtrl_item_code')).getValue();
                    ...
                    items: [
                        {
                            ...
                            items: [
                                {
                                    xtype:'combo',
                                    id:gu.id('manage_mtrl_account_type'),
                                    name:'account_type',
                                    mode: 'local',
                                    padding: '0 0 5px 0',
                                    ...
                                    value:type=='EDIT'||type=='COPY' ? select.get('account_type') : 'R'
                                },{
                                    xtype:'combo',
                                    id:gu.id('manage_mtrl_class_1'),
                                    name:'class_1',
                                    mode: 'local',
                                    ...
                                    xtype:'textfield',
                                    id:gu.id('manage_mtrl_item_name'),
                                    name:'item_name',
                                    padding: '0 0 5px 0',
                                    width:'45%',
                                    allowBlank:false,
                                    ...
                                    xtype:'textfield',
                                    id:gu.id('manage_mtrl_specification'),
                                    name:'specification',
                                    padding: '0 0 5px 30px',
                                    width:'45%',
                                    allowBlank:false,
                                    ...
                                    xtype:'combo',
                                    id:gu.id('manage_mtrl_maker_uid'),
                                    name:'maker_uid',
                                    mode: 'local',
                                    padding: '0 0 5px 30px',
                                    // fieldLabel: '<font color=red>*</font>계정',
                                    ...
                                    xtype:'textfield',
                                    id:gu.id('manage_mtrl_unit_code'),
                                    name:'unit_code',
                                    padding: '0 0 5px 0',
                                    width:'45%',
                                    fieldLabel:'단위',
                                    ...
                                    xtype:'numberfield',
                                    id:gu.id('manage_mtrl_std_sell_price'),
                                    name:'std_sell_price',
                                    padding: '0 0 5px 0',
                                    width:'45%',
                                    fieldLabel:'표준판매단가',
                                    ...
                                    xtype:'numberfield',
                                    id:gu.id('manage_mtrl_std_pur_price'),
                                    name:'std_pur_price',
                                    padding: '0 0 5px 30px',
                                    width:'45%',
                                    fieldLabel:'표준구매단가',
                                    ...
                                    xtype:'textfield',
                                    id:gu.id('manage_mtrl_description'),
                                    name:'description',
                                    padding: '0 0 5px 30px',
                                    width:'45%',
                                    fieldLabel:'설명',
        ...
        var win = Ext.create('Ext.Window', {
            ...
            buttons: [{
                ...
                handler: function(btn) {
                    var form = Ext.getCmp(gu.id('manage_mtrl_form')).getForm();
                    if(form.isValid()) {
    ...
    accountTypeStore:Ext.create('Msys.store.CommonCodeStore', {code_group:'MATERIAL_ACCOUNT'}),
