Ext.define('Msys.views.master.RegistVocView', {
    extend:'Msys.base.BaseView',
    initComponent: function() {
	
        console.log('MSYS Views master RegistVocModel', this.columns);
		...
		//스토어 생성
        this.createStore('Msys.model.RegistVocModel', gu.pageSize);
                    ...
                    items: [
                        {
                            ...
                            items:[
								...
								new Ext.form.Hidden({
                                	  id:'status',
                                      name: 'status',
                                      value: (type=='ADD')? 'R' : record.get('status')
                                }),
								new Ext.form.Hidden({
                                	  id:'type',
                                      name: 'type',
                                      value: (type=='ADD')? 'V' : record.get('type')
                                }),
								new Ext.form.Hidden({
                                	  id:'unique_id',
                                      name: 'unique_id',
